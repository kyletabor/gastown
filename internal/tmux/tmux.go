...
// Without exclusion, the caller would be killed before completing the cleanup.
//
// The excludePIDs parameter should include the current process (os.Getpid()) and
// optionally any ancestor PIDs that should survive until RespawnPane is called.
